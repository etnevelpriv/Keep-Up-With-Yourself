...
A korabbi feladatokhoz tartozik 1-1 badge (a badge-nek 3 tipusa van).
	- Folyamatban (Ha a felhasznalo letrehozza a feladatot, akkor ez az alapertelmezett badge. A badge akkor cserelodik le, ha a hatarido lejar, vagy a feladatot teljesitettek)
	- Lejart (Ha a hatarido lejart a feladat teljesitese elott)
	- Teljesitett (Ha a felhasznalo teljesitettnek jeloli be a feladatot)
...
Egyet ahol tud letrehozni feladatot, egyet, ahol megtekintheti korabbi feladatai, egyet ahol lathatja sajat adatait. 
A korabbi feladatok oldalon a felhasznalo lathat statisztikakat a feladatairol.
A statisztikak megmutatja a befejezett feladatok aranyat, a feladatok tipusait, es az atlagos hataridoket az adott fontossagi sorrendekhez.

Az adatbazisok strukturaja a kovetkezo:
task:
	- userId (string)
	- taskId (string)
	- taskName (string)
...
3-an keszitjuk a projektet. Rasztovits Levente (etnevelpriv), Kover Marcell (M4rc1xd), Borbara Kristof (k3i2t0r)
Tervezett felhasznalt technologiak: TypeScript, HTML, CSS, Firebase Auth, Firestore, Firebase Host, Node.js, vite, vitest

Fejlesztesi folyamat:
0. Inicializalas, elokeszules [Otleteles: Mindenki, Inicializalas es elokeszites: Levente] (0 / x)
...
1. Auth letrehozasa [Kod: Levente, Teszt: Kristof] (0 / x)
...
2. Firestore db felallitasa es szabalyok megirasa [Config: Levente] (0 / x)
...
3. Landing page elkeszitese [Kod: Levente] (0 / x)
...
4. Letrehozas oldal elkeszitese [Kod: Marci, Backend: Levente Teszt: Kristof] (0 / x)
...
5. Listazas oldal elkeszitese [Kod es teszteles: Kristof] (0 / x)
...
6. Taskok frissetese [Kod: Marci, Teszt: Levente] (0 / x)
...
7. Profil oldal elkeszitese [Kod: Kristof] (0 / x)
...
8. Vegso simitasok - Nem kotelezo jelleggel, csak ha mar tenyleg minden kesz es meg akarnam folytatni [Config, aprosagok, deploy: Levente] (0 / x)
